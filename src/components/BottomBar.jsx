...
const menuItems = [
  { icon: Home, label: 'الرئيسية', href: '#home', id: 'home' },
  { icon: CalendarHeart, label: 'الفعاليات', href: '#event', id: 'event' },
  { icon: MapPin, label: 'الموقع', href: '#location', id: 'location' },
  { icon: MessageCircleHeart, label: 'التهاني', href: '#wishes', id: 'wishes' },
];
...
const BottomBar = () => {
  ...
  const content = (
    <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2 z-50 w-full max-w-[430px] flex justify-center px-4 pointer-events-none">
      <motion.div
  ...
  // Render via portal to avoid being constrained by transformed/overflow ancestors
